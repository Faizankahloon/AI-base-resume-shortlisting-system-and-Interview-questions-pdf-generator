...
function JobDescription() {
    ...
    const handleCountChange = (e) => setCount(e.target.valueAsNumber)
    ...
    const pollShortlisted = (retries = 15, interval = 2000) => {
        const user_id = localStorage.getItem('username');  // ← get user
        let attempts = 0;
    ...
    return (
        <div >
            ...
            <div className="d2">
                ...
                <input className="inp1" type="text" placeholder="e.g. Software Engineer" onChange={handleTitleChange} />
                ...
                <input className="inp5" type="number" value={count} onChange={handleCountChange} />
